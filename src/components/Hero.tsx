...
const Hero = () => {
  ...
  return (
    <section className="relative w-full bg-[#fafafa] text-foreground overflow-hidden selection:bg-primary selection:text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-10 sm:pb-14 min-h-[92vh] lg:min-h-[88vh] flex flex-col">
        {/* TOP META BAR */}
        <motion.div
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="flex items-center justify-between border-t border-black/10 pt-4 mb-8 sm:mb-12 text-[10px] sm:text-xs uppercase tracking-[0.25em] font-bold"
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="text-primary">§ Агентство роста</span>
