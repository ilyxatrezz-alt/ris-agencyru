...
const WebDevelopment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Создание сайтов под ключ — РИС | Сайты, которые продают</title>
        <meta 
          name="description" 
          content="Разработка продающих сайтов за 3-7 дней. Лендинги, корпоративные сайты, интернет-магазины. 200+ проектов, гарантия результата." 
        />
      </Helmet>
