...
> = {
  ...
  "f0f41b44-0a35-45fa-8aca-328a871846c0": {
    subtitle: "Сайт доставки суши + перформанс-реклама в Донецке",
    challenge:
      "Локальный рынок доставки в Донецке без явного лидера. Нужно было быстро занять верх выдачи и забрать основную долю заказов.",
    solution: [
      "Разработали продающий сайт доставки с удобным каталогом, корзиной и онлайн-оплатой",
      "Запустили Яндекс.Директ на горячие запросы «суши доставка Донецк»",
      "Развернули медийку в РСЯ с креативами под акции и сеты выходного дня",
      "Настроили ретаргетинг на брошенные корзины и повторные заказы",
    ],
    result:
      "Стали №1 по доставке суши в Донецке: x7.4 окупаемость рекламы, средний чек вырос на 28%.",
    period: "6 месяцев",
    geo: "Донецк",
    services: ["Сайт доставки", "Яндекс.Директ", "РСЯ", "Ретаргетинг"],
  },
  "d2a33487-1a2e-4094-b8f5-f81179ce69a4": {
    subtitle: "Единая платформа доставки для двух концепций ресторанной группы",
    challenge:
      "Rave Family объединяет мясное бистро Rave и паназиатский Asiabar. Нужен был общий хаб доставки и единая рекламная стратегия без каннибализации трафика.",
    solution: [
      "Собрали мультибрендовый сайт-доставку с раздельными каталогами и общим чек-аутом",
      "Запустили Яндекс.Директ отдельно на бургеры и отдельно на азиатскую кухню",
      "Развернули РСЯ с премиум-креативами и видео-роликами блюд",
      "Настроили сегментацию аудиторий и кросс-промо между двумя концепциями",
    ],
    result:
      "x6.1 окупаемость рекламы, +43% к выручке доставки за квартал, рост повторных заказов в 2.2 раза.",
    period: "4 месяца",
    geo: "Донецк",
    services: ["Мультибрендовый сайт", "Яндекс.Директ", "РСЯ", "Кросс-промо"],
  },
  "175f14cc-206d-46cc-ad7a-38b315fd741b": {
    subtitle: "Пивоварня и ресторан в центре Донецка",
    challenge:
      "Сильный продукт — живое пиво собственной варки и кухня на углях, но онлайн-присутствие не отражало уровень заведения. Нужно было собрать брони и самовывоз на постоянный поток.",
    solution: [
      "Разработали премиум-сайт с атмосферой пивоварни, меню, бронированием стола и самовывозом",
      "Запустили Яндекс.Директ на горячие запросы «пивоварня Донецк», «ресторан Донецк», «крафтовое пиво»",
      "Развернули РСЯ с видео-креативами: разлив, кухня на углях, атмосфера зала",
      "Подключили ретаргетинг и работу с отзывами в Яндекс.Картах и 2ГИС",
    ],
    result:
      "Стабильный поток броней и самовывоза, заполненность зала по вечерам близко к 100%, x5.4 окупаемость рекламы.",
    period: "4 месяца",
    geo: "Донецк",
    services: ["Сайт ресторана", "Бронь стола онлайн", "Яндекс.Директ", "РСЯ", "Репутация"],
  },
  "b75632f8-c1a9-4098-bf8f-68d7e2050be7": {
    subtitle: "Перформанс-маркетинг для сети ресторанов в Польше",
    challenge:
      "Молодая сеть с двумя локациями в Кракове и Катовице. Высокая конкуренция за бронирования и hard sell от классических соцсетей — нужен был чистый перформанс.",
    solution: [
      "Собрали продающий сайт-бренд с онлайн-бронированием по двум локациям",
      "Запустили Google Ads: Search + Performance Max с гео-таргетингом на Краков и Катовице",
      "Развернули Instagram Ads с креативами интерьера, шеф-поваров и сезонного меню",
      "Подключили динамический ретаргетинг и lookalike на гостей премиум-сегмента",
    ],
    result:
      "x5.7 окупаемость рекламы, заполненность зала по будням +65%, лист ожидания на выходные.",
    period: "5 месяцев",
    geo: "Краков + Катовице, Польша",
    services: ["Сайт бренда", "Google Ads", "Instagram Ads", "Ретаргетинг"],
  },
};
