...
const Smm = () => {
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>SMM продвижение — Агентство РИС | Ведение соцсетей</title>
        <meta name="description" content="Профессиональное SMM продвижение для бизнеса. Ведение ВКонтакте, Telegram, контент-маркетинг, таргетированная реклама. Кейс: Гипермаркет ПАНДА." />
      </Helmet>
      <Header />
